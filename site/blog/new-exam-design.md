...
The body of the exam stays close to the old design. Black text on a white background, no decorative shapes, no gray boxes, no icons. This isn't a stylistic preference, it's just the simplest and least distracting, which is what you want when you're asking people to read for up to 3 hours.

I dropped the word <span lang="nl">"Vraag"</span> before every question number, because it adds no information. Everyone already knows what a question number is (and if you don't, you probably should not be making your exams).
